...
# KoGPT
kogpt_tokenizer = PreTrainedTokenizerFast.from_pretrained(KOGPT_MODEL)
kogpt_tokenizer.pad_token = kogpt_tokenizer.eos_token  # 필수 설정
kogpt_model = GPT2LMHeadModel.from_pretrained(KOGPT_MODEL, torch_dtype=torch.float16).to(DEVICE)
kogpt_model.eval()
